...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Dmitrii\Desktop\SQLALCHEMY\sqlalchemy'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Dmitrii\Desktop\SQLALCHEMY\sqlalchemy\Scripts\deactivate.nu'
